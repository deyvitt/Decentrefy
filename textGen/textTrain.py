...
from dataloader import TextTranDataset
from ipfsConnect import IPFSConn
...
batch_size = config['textTrain']['batch_size']
epochs = config['textTrain']['epochs']
threshold = config['textTrain']['threshold']
checkpoint_path = config['textTrain']['checkpoint_path']
fine_tuned_checkpoint_path = config['textTrain']['fine_tuned_checkpoint_path']
...
def main():
    ...
    # Call the generator_task function
    generator_task(model)
