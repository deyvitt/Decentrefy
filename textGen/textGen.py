...
from textGenEncoder import Encoder
...
class TextTransformer(nn.Module):
    def __init__(self, embed_size, heads, dropout, forward_expansion):
        ...
        self.sliding_window_attention = MultiheadAttention(embed_size, heads, dropout=dropout)
        self.global_attention = MultiheadAttention(embed_size, heads, dropout=dropout)
